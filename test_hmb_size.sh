...
# Ex: bash test_hmb_size.sh LiveJournal.pl 5 526M 18M
# Ex: bash test_hmb_size.sh Twitter-2010.pl 5 11G 160M
...
output_path="experiments/hmb_size_${dataset_path}_${x_percentage}%_p${num_partition}.txt"
